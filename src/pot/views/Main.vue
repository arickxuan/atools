...
import { translateDeepl, tts, translateGoogleProxy, baidu_detect,translateTencentProxy } from '../tools/translate'
// import { useI18n } from 'vue-i18n'
import zh from '../i18n/locales/zh_CN.json'
import { languageList, ttsLanguage } from '../tools/language.ts'
...
const result = ref({ deepl: '', google: '', tencent: '', yandex: '' })
...
async function doTranslate() {
    ...
    re = await translateGoogleProxy(textarea.value, newFromlan, newToLan)
    ...
    re = await translateTencentProxy(textarea.value, newFromlan, newToLan)
    result.value.tencent = re
